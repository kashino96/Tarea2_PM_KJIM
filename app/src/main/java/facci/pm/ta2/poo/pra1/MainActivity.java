...
import facci.pm.ta2.poo.datalevel.DataLowLevel;
...
public class MainActivity extends AppCompatActivity  {
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            Log.d("DEBUG", String.format("Main thread: %d", Thread.currentThread().getId()));


            // ************************************************

            // INICIO - CODE1 // Programación similar a la que se realiza con servicios back-end como Firebase.
